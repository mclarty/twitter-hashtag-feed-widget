...
This is a sidebar widget that creates a simple, clean Twitter feed of a specified hashtag.

== Description ==

This is a sidebar widget that creates a simple, clean Twitter feed of a specified hashtag.  This widget is specifically designed to render a clean, lightweight widget that can be completely styled by the user through CSS.

== Installation ==

1. Upload the `twitter-hashtag-feed` directory to the `/wp-content/plugins/` directory
